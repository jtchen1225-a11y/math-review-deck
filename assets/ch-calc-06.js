...
(function() {
  ...
  "color": "#0284c7",
  "sections": [
    "單選題 1~6 題 (坐標對稱、共面、垂直平行、中點分解、夾角鈍角)"
  ],
  "slides": [
    {
      "year": "2026",
      ...
      "knowledge": {
        ...
        "points": [
          "<b>對稱坐標口訣</b>：「關誰誰不變，其餘全變號」！",
          "<b>關於 z 軸對稱</b>：$z$ 坐標保持不變，$x, y$ 坐標分別取相反數。"
        ],
    ...
    },
    {
      ...
      "knowledge": {
        ...
        "points": [
          "<b>向量坐標表示</b>：$\\vec{AB} = (-2, 2, -2)$，$\\vec{AC} = (1, 6, -8)$，$\\vec{AP} = (x-4, -2, 0)$。",
          "<b>法向量點乘為 0</b>：求出平面法向量後與 $\\vec{AP}$ 做數量積等於 0。"
        ],
    ...
    },
    {
      ...
      "knowledge": {
        ...
        "points": [
          "<b>垂直條件列方程</b>：$\\vec{a} \\cdot \\vec{c} = 2x - 4 + 2 = 0 \\implies x = 1$。",
          "<b>平行條件求比例</b>：$\\frac{1}{2} = \\frac{y}{-4} = \\frac{1}{2} \\implies y = -2$。",
          "<b>向量線性組合與模長</b>：$2\\vec{a} + \\vec{b} = (3, 0, 3)$。"
        ],
    ...
    },
    {
      ...
      "knowledge": {
        ...
        "points": [
          "<b>確定共線比例係數</b>：$k = \\frac{2}{-1} = -2$；$k = \\frac{-1}{1/2} = -2$。",
          "<b>求出未知數</b>：$\\frac{m}{2} = -2 \\implies m = -4$。"
        ],
    ...
    },
    {
      ...
      "knowledge": {
        ...
        "points": [
          "<b>平行四邊形/中點向量法則</b>：$G$ 為 $CD$ 中點，以 $B$ 為起點的向量 $\\vec{BD} + \\vec{BC} = 2\\vec{BG}$。",
          "<b>首尾相接消去中繼點</b>：$\\vec{AB} + \\vec{BG} = \\vec{AG}$。"
        ],
    ...
    },
    {
      ...
      "knowledge": {
        ...
        "points": [
          "<b>鈍角核心條件</b>：$\\cos\\theta < 0 \\iff \\vec{a} \\cdot \\vec{b} < 0$。",
          "<b>致命陷阱：排除反向共線</b>：若兩向量反向共線，夾角為 $180^\\circ$（平角），不是鈍角！必須排除 $\\vec{b} = k\\vec{a}$ ($k < 0$) 的情況。"
        ],
