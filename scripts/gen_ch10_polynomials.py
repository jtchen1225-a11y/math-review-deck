# -*- coding: utf-8 -*-
"""
scripts/gen_ch10_polynomials.py
專題十：多項式除法、餘式定理、分式與無理方程 (Book P20-24, PDF P18-22, 10 slides)
"""
...
output_js = f"/* 2026 高三理組數學思維本 — 專題十 多項式除法、餘式定理、分式與無理方程 ({len(slides)} 題) */\n(function() {{\n  const DECK = window.DECK = window.DECK || [];\n  DECK.push({json.dumps(deck_obj, ensure_ascii=False, indent=2)});\n}})();\n"

with open("demo/ch-senior-10.js", "w", encoding="utf-8") as f:
    f.write(output_js)

print(f"Generated demo/ch-senior-10.js with {len(slides)} slides.")
