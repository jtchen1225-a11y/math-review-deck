# -*- coding: utf-8 -*-
"""
scripts/gen_ch20_complex.py
專題二十：複數 — 四則運算、共軛、棣美弗定理與幾何應用 (Book P52-55, PDF P50-53, 6 slides)
"""
...
output_js = f"/* 2026 高三理組數學思維本 — 專題二十 複數 ({len(slides)} 題) */\n(function() {{\n  const DECK = window.DECK = window.DECK || [];\n  DECK.push({json.dumps(deck_obj, ensure_ascii=False, indent=2)});\n}})();\n"

with open("demo/ch-senior-20.js", "w", encoding="utf-8") as f:
    f.write(output_js)

print(f"Generated demo/ch-senior-20.js with {len(slides)} slides.")
