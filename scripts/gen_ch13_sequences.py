# -*- coding: utf-8 -*-
"""
scripts/gen_ch13_sequences.py
專題十三：數列與級數 (Book P28-30, PDF P26-28, 8 slides)
"""
...
output_js = f"/* 2026 高三理組數學思維本 — 專題十三 數列與級數 ({len(slides)} 題) */\n(function() {{\n  const DECK = window.DECK = window.DECK || [];\n  DECK.push({json.dumps(deck_obj, ensure_ascii=False, indent=2)});\n}})();\n"

with open("demo/ch-senior-13.js", "w", encoding="utf-8") as f:
    f.write(output_js)

print(f"Generated demo/ch-senior-13.js with {len(slides)} slides.")
