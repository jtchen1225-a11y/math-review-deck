...
CHAPTER_DATA = {
    ...
    "slides": [
        ...
        },
        {
            ...
            "knowledge": {
                "formulas": ["\\vec{b} = \\lambda \\vec{a} \\iff \\frac{b_1}{a_1} = \\frac{b_2}{a_2} = \\frac{b_3}{a_3} = \\lambda"],
                "points": ["<b>向量共線</b>即對應坐標成比例。"]
            },
            "solution": {
        ...
        },
        {
            ...
            "knowledge": {
                ...
                "points": ["先求出差向量 $\\vec{b} - \\vec{c}$，再令數量積為 0 列方程。"]
            },
            "solution": {
        ...
        },
        {
            ...
            "options": ["A. $-\\sqrt{2}$", "B. $\\sqrt{2}$", "C. -1", "D. 1"],
            "knowledge": {
                "formulas": [
        ...
        },
        {
            ...
            "options": ["A. $\\sqrt{14}$", "B. $\\sqrt{10}$", "C. $\\sqrt{29}$", "D. $2\\sqrt{7}$"],
            "knowledge": {
                "formulas": [
        ...
        },
        {
            ...
            "options": ["A. 2", "B. $\\sqrt{70}$", "C. $\\sqrt{2}$", "D. $\\sqrt{34}$"],
            "knowledge": {
                "formulas": [
        ...
        },
        {
            ...
            "knowledge": {
                ...
                "points": ["空間解析中叉積方向遵循右手定則，結果為一個與兩向量均垂直的向量。"]
            },
            "solution": {
