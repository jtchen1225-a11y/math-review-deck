# -*- coding: utf-8 -*-
"""
scripts/gen_ch16_trig.py
專題十六：三角函數與解三角形 (Book P37-43, PDF P35-41, 6 slides)
"""
...
output_js = f"/* 2026 高三理組數學思維本 — 專題十六 三角函數與解三角形 ({len(slides)} 題) */\n(function() {{\n  const DECK = window.DECK = window.DECK || [];\n  DECK.push({json.dumps(deck_obj, ensure_ascii=False, indent=2)});\n}})();\n"

with open("demo/ch-senior-16.js", "w", encoding="utf-8") as f:
    f.write(output_js)

print(f"Generated demo/ch-senior-16.js with {len(slides)} slides.")
