# -*- coding: utf-8 -*-
"""
Ch 01: 專題一 導數的定義、運算法則與高階求導 (28 題組)
涵蓋：單選 1~6、填空 7~9、解答 10(1~12)、11(1~9)、12(1~2)、13(1~2)、14~17、18~20、21~22、23~28
"""
...
def get_ch01_slides():
    slides = [
        # 1
        {
            "year": "2026", "paper": "專題一", "qNum": "單選題 第1題",
            "topic": "基本初等函數的導數與求值", "score": "4分",
            "q": "已知函數 $f(x) = \\sin x + x$，則 $\\left.\\frac{df}{dx}\\right|_{x=1}$ 的值為 $(\\quad)$。",
            "options": ["A. $1 - \\cos 1$", "B. $1 + \\cos 1$", "C. \\cos 1 - 1", "D. -1 - \\cos 1"],
            "knowledge": {
                "formulas": ["(\\sin x)' = \\cos x", "(x)' = 1", "(u + v)' = u' + v'"],
                "points": ["<b>和差求導法則</b>：$(f \\pm g)' = f' \\pm g'$。", "<b>特定點求值</b>：先求導函數 $f'(x)$，再代入自變量值 $x=1$。"],
        ...
        # 2
        {
            "year": "2026", "paper": "專題一", "qNum": "單選題 第2題",
            "topic": "導數的物理意義 — 瞬時速度與停頓時刻", "score": "4分",
            "q": "一質點沿直線運動，如果由始點起經過 $t$ 秒後的位移為 $s = \\frac{1}{3}t^3 - \\frac{3}{2}t^2 + 2t$，那麼速度為零的時刻是 $(\\quad)$。",
            "options": ["A. 0 秒", "B. 1 秒末", "C. 2 秒末", "D. 1 秒末和 2 秒末"],
            "knowledge": {
                "formulas": ["v(t) = s'(t) = \\frac{ds}{dt}", "a(t) = v'(t) = s''(t)"],
                "points": ["<b>瞬時速度</b>：位移函數對時間的一階導數即為速度 $v(t) = s'(t)$。", "<b>速度為零</b>：令 $v(t) = 0$ 解一元二次方程。"],
        ...
        # 3
        {
            "year": "2026", "paper": "專題一", "qNum": "單選題 第3題",
            "topic": "含參函數求導與方程求解", "score": "4分",
            "q": "已知 $m < 0$，$f(x) = mx^3 + \\frac{27x}{m}$，且 $f'(1) = -18$，則實數 $m$ 等於 $(\\quad)$。",
            "options": ["A. -9", "B. -3", "C. 3", "D. 9"],
            "knowledge": {
                "formulas": ["(x^n)' = n x^{n-1}", "f'(x) = 3m x^2 + \\frac{27}{m}"],
                "points": ["<b>多項式求導</b>：注意 $\\frac{27x}{m} = \\left(\\frac{27}{m}\\right)x$，其導數為常數 $\\frac{27}{m}$。", "<b>參數約束</b>：題幹明確給出 $m < 0$，解出方程後需檢驗符號。"],
        ...
        # 4
        {
            "year": "2026", "paper": "專題一", "qNum": "單選題 第4題",
            "topic": "平均變化率的定義與差商計算", "score": "4分",
            "q": "在曲線 $y = x^2 + 1$ 的圖像上取一點 $(1,2)$ 及鄰近一點 $(1+\\Delta x, 2+\\Delta y)$，則 $\\frac{\\Delta y}{\\Delta x}$ 為 $(\\quad)$。",
            "options": ["A. $\\Delta x + \\frac{1}{\\Delta x} + 2$", "B. $\\Delta x - \\frac{1}{\\Delta x} - 2$", "C. $\\Delta x + 2$", "D. $2 + \\Delta x - \\frac{1}{\\Delta x}$"],
            "knowledge": {
                "formulas": ["\\Delta y = f(x_0 + \\Delta x) - f(x_0)", "\\frac{\\Delta y}{\\Delta x} = \\frac{f(x_0 + \\Delta x) - f(x_0)}{\\Delta x}"],
                "points": ["<b>割線斜率（差商）</b>：$\\frac{\\Delta y}{\\Delta x}$ 表示自變量變化 $\\Delta x$ 時函數的平均變化率。", "<b>消去零因子</b>：展開分子後提出 $\\Delta x$ 並約分。"],
        ...
        # 5
        {
            "year": "2026", "paper": "專題一", "qNum": "單選題 第5題",
            "topic": "絕對值函數的局部求導", "score": "4分",
            "q": "函數 $f(x) = |x|$，則 $f'(5) = (\\quad)$。",
            "options": ["A. 不存在", "B. 0", "C. 1", "D. -1"],
            "knowledge": {
                "formulas": ["|x| = \\begin{cases} x, & x \\ge 0 \\\\ -x, & x < 0 \\end{cases}", "(|x|)' = \\text{sgn}(x) \\quad (x \\ne 0)"],
                "points": ["<b>局部去絕對值</b>：當 $x$ 在 5 的鄰域內時，$x > 0$，故 $|x| = x$。", "<b>可導性判斷</b>：$|x|$ 僅在原點 $x=0$ 處不可導，其餘非零點處均處處可導。"],
        ...
        # 6
        {
            "year": "2026", "paper": "專題一", "qNum": "單選題 第6題",
            "topic": "導函數條件逆推原函數", "score": "4分",
            ...
            "knowledge": {
                "formulas": ["(x^n)' = n x^{n-1}", "(C)' = 0"],
                "points": ["<b>選項驗證法</b>：分別求各選項函數在 $x=1$ 處的導數值進行檢驗。", "<b>多項式常數項</b>：常數項求導均為 0，B、C、D 項的導數本質相同。"],
        ...
        # 7
        {
            "year": "2026", "paper": "專題一", "qNum": "填空題 第7題",
            "topic": "導數定義的極限形式轉化", "score": "4分",
            "q": "若 $f'(x_0) = 2$，則 $\\lim_{k \\to 0} \\frac{f(x_0 - k) - f(x_0)}{2k} = \\underline{\\quad\\quad\\quad\\quad}$。",
            "options": [],
            "knowledge": {
                "formulas": ["f'(x_0) = \\lim_{\\Delta x \\to 0} \\frac{f(x_0 + \\Delta x) - f(x_0)}{\\Delta x}", "\\lim_{k \\to 0} \\frac{f(x_0 + A k) - f(x_0)}{B k} = \\frac{A}{B} f'(x_0)"],
                "points": ["<b>增量匹配</b>：分子中的增量為 $-k$，分母為 $2k$。", "<b>提係數法</b>：$\\frac{f(x_0 - k) - f(x_0)}{2k} = -\\frac{1}{2} \\cdot \\frac{f(x_0 + (-k)) - f(x_0)}{-k}$。"],
        ...
        # 8
        {
            "year": "2026", "paper": "專題一", "qNum": "填空題 第8題",
            "topic": "原點處導數定義極限", "score": "4分",
            "q": "已知 $f(x) = \\sin x$，則 $\\lim_{h \\to 0} \\frac{f(h) - f(0)}{h} = \\underline{\\quad\\quad\\quad\\quad}$。",
            "options": [],
            "knowledge": {
                "formulas": ["f'(0) = \\lim_{h \\to 0} \\frac{f(0 + h) - f(0)}{h}", "(\\sin x)' = \\cos x"],
                "points": ["<b>定義識別</b>：該極限即為函數 $f(x)$ 在 $x = 0$ 處的導數定義 $f'(0)$。", "<b>三角特殊值</b>：$\\cos 0 = 1$。"],
        ...
        # 9
        {
            "year": "2026", "paper": "專題一", "qNum": "填空題 第9題",
            "topic": "二次函數導數待定係數", "score": "4分",
            "q": "設函數 $f(x) = x^2 + ax + 12$，已知 $f'(4) = 2$，則實數 $a$ 的值為 $\\underline{\\quad\\quad\\quad\\quad}$。",
            "options": [],
            "knowledge": {
                "formulas": ["(x^2 + ax + b)' = 2x + a"],
                "points": ["<b>一次項與二次項求導</b>：$f'(x) = 2x + a$。", "<b>線性方程求解</b>：令 $2(4) + a = 2$ 解一元一次方程。"],
        ...
        # 10
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第10題(1~3)",
            "topic": "基本求導法則練習 (根式、積、商)", "score": "10分",
        ...
        # 11 -> 10(4~6)
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第10題(4~6)",
            "topic": "基本求導法則練習 (商法則、多項式負冪、三角平方)", "score": "10分",
            ...
            "knowledge": {
                ...
                "points": ["<b>(4) 分式商求導</b>：注意分子項的合併化簡。", "<b>(5) 負整數指數冪</b>：改寫為 $-3x^{-1} + 2x^{-2}$ 直接套用冪法則。", "<b>(6) 複合求導與倍角公式</b>：利用二倍角公式化簡結果。"],
        ...
        # 12 -> 10(7~9)
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第10題(7~9)",
            "topic": "基本求導法則練習 (分數指數冪、根式複合、三角線性)", "score": "10分",
            ...
            "knowledge": {
                ...
                "points": ["<b>分數指數冪求導</b>：根號化為指數 $x^{2/3}$，負冪化為 $x^{-2}$。", "<b>根式速導公式</b>：$(\\sqrt{u})' = \\frac{u'}{2\\sqrt{u}}$ 聯考最常用。"],
        ...
        # 13 -> 10(10~12)
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第10題(10~12)",
            "topic": "基本求導法則練習 (負指數多項式、除法拆項、乘積法則)", "score": "10分",
            ...
            "knowledge": {
                ...
                "points": ["<b>(10) 展開法或乘積法</b>：展開後各項求導最穩。", "<b>(11) 逐項除以分母</b>：化為多項式與負冪之和，避免複雜商法則。", "<b>(12) 乘積法則</b>：一次多項式乘正弦函數。"],
        ...
        # 14 -> 11(1~3)
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第11題(1~3)",
            "topic": "複合函數鏈式求導 (三角、根式、冪)", "score": "10分",
            ...
            "knowledge": {
                ...
                "points": ["<b>外層先導、內層再導</b>：鏈式法則的核心是層層剝繭。", "<b>內層導數不可漏</b>：(1) 的 $1/4$，(2) 的 $3$，(3) 的 $5$。"],
        ...
        # 15 -> 11(4~6)
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第11題(4~6)",
            "topic": "複合函數鏈式求導 (高次冪、分母高次、三角相角)", "score": "10分",
            ...
            "knowledge": {
                ...
                "points": ["<b>(5) 改寫為負冪</b>：$y = (2x^2 - 1)^{-3}$，避免使用商法則。", "<b>(5) 內層是二次式</b>：內層 $(2x^2 - 1)' = 4x$。"],
        ...
        # 16 -> 11(7~9)
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第11題(7~9)",
            "topic": "多重複合函數求導 (對數三角、指數函數、乘積與三角二次)", "score": "10分",
            ...
            "knowledge": {
                ...
                "points": ["<b>(7) 三重複合</b>：$\\ln \\to \\sin \\to (2x+1)$，結果化簡為 $2\\cot(2x+1)$。", "<b>(8) 一般底數指數求導</b>：必須乘上 $\\ln 4$ 與內層導數。", "<b>(9) 乘積與複合並存</b>：外層乘積，後項複合。"],
        ...
        # 17 -> 12(1~2)
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第12題",
            "topic": "高階導數 — 二階導數的計算 (顯函數與隱函數)", "score": "10分",
            ...
            "knowledge": {
                ...
                "points": ["<b>(1) 連續求導兩次</b>：先求 $y'$ 再對 $y'$ 求導。", "<b>(2) 隱函數二階求導</b>：對一階導式再次對 $x$ 求導，並將 $y'$ 與原方程代入回代化簡！"],
        ...
        # 18 -> 13(1~2)
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第13題",
            "topic": "隱函數的一階導數求法", "score": "10分",
            ...
            "knowledge": {
                ...
                "points": ["<b>兩邊同時對 x 求導</b>：遇 $y$ 的函數時，視 $y$ 為 $x$ 的函數，求導後必乘 $\\frac{dy}{dx}$。", "<b>移項因式分解</b>：將含 $\\frac{dy}{dx}$ 的項移到左邊，其餘項移到右邊解出。"],
        ...
        # 19 -> 14
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第14題",
            "topic": "有理分式的高階導數與給定點求值", "score": "8分",
            ...
            "knowledge": {
                ...
                "points": ["<b>一階導求值</b>：代入 $x=1$ 得分子 $1 - 1^2 = 0$！", "<b>二階導求值</b>：代入 $x=-1$，注意約去公因式 $(x^2+1)$。"],
        ...
        # 20 -> 15
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第15題",
            "topic": "多項式的一階與二階導數點值", "score": "6分",
            "q": "設 $y = x^5 - 5x^3$，求 $f'(2)$ 及 $f''(1)$。",
            "options": [],
            "knowledge": {
                "formulas": ["f'(x) = 5x^4 - 15x^2", "f''(x) = 20x^3 - 30x"],
                "points": ["<b>冪函數連續求導</b>：逐次降冪乘係數。", "<b>代入指定點計算</b>：$2^4 = 16, 2^2 = 4$。"],
        ...
        # 21 -> 16
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第16題",
            "topic": "原點處一階與二階導數計算", "score": "6分",
            ...
            "knowledge": {
                ...
                "points": ["<b>在原點求導的特徵</b>：求導後令 $x=0$，即為導函數的常數項！"],
        ...
        # 22 -> 17
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第17題",
            "topic": "三次多項式指定點導數計算", "score": "6分",
            "q": "設函數 $f(x) = x^3 - 6x^2 + 9x + 2$，求 $f'(-2)$ 及 $f''(0)$。",
            "options": [],
            "knowledge": {
                "formulas": ["f'(x) = 3x^2 - 12x + 9", "f''(x) = 6x - 12"],
                "points": ["<b>負數代入注意符號</b>：$(-2)^2 = 4, -12(-2) = +24$。", "<b>二階導在 0 處</b>：常數項為 -12。"],
        ...
        # 23 -> 18
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第18題",
            "topic": "圓柱表面積函數構建與一二階求導", "score": "8分",
            ...
            "knowledge": {
                ...
                "points": ["<b>消元法</b>：利用體積公式將高 $h$ 用底半徑 $x$ 表示。", "<b>表面積組成</b>：兩個底圓面積 $2\\pi x^2$ 加上側面展開面積 $2\\pi x h$。"],
        ...
        # 24 -> 19
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第19題",
            "topic": "正圓錐幾何關係與體積平方函數求導", "score": "8分",
            ...
            "knowledge": {
                ...
                "points": ["<b>母線長表示</b>：側面展開扇形面積加底圓面積等於全表面積 $4\\pi$。", "<b>勾股定理求高</b>：$h^2 = l^2 - r^2 = \\frac{(4-r^2)^2 - r^4}{r^2} = \\frac{16 - 8r^2}{r^2}$。"],
        ...
        # 25 -> 20
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第20題",
            "topic": "正圓柱體積函數與高階導數", "score": "8分",
            ...
            "knowledge": {
                ...
                "points": ["<b>自變量範圍</b>：$0 < x < 36$。", "<b>三次多項式求導</b>：展開後逐項求導。"],
        ...
        # 26 -> 21
        {
            "year": "2026", "paper": "專題一", "qNum": "單選題 第21題",
            "topic": "原函數與導函數圖像對應辨析", "score": "4分",
            ...
            "options": ["A. 選項 A", "B. 選項 B (過原點斜率為負的直線)", "C. 選項 C", "D. 選項 D"],
            "knowledge": {
                "formulas": [
                    "f(x) = a x^2 + c \\quad (a < 0)",
                    "f'(x) = 2a x \\quad (2a < 0)"
                ],
                "points": ["<b>二次函數求導為一次函數</b>：拋物線的導函數必然是一條直線！", "<b>斜率的正負</b>：原圖開口向下，說明 $a < 0$，因此導函數直線的斜率 $2a < 0$（遞減直線）。", "<b>過原點性質</b>：對稱軸為 $x=0$，極值點在原點，故 $f'(0) = 0$，直線必過原點 $(0, 0)$。"],
        ...
        # 27 -> 22
        {
            "year": "2026", "paper": "專題一", "qNum": "單選題 第22題",
            "topic": "三次函數導函數特徵與圖像選擇", "score": "4分",
            ...
            "knowledge": {
                ...
                "points": ["<b>開口方向</b>：$x^2$ 的係數為 $+1 > 0$，故拋物線必開口向上，排除 (2) 和 (4)。", "<b>對稱軸位置</b>：對稱軸為 $x = -a$。題幹指明 $a \\ne 0$，因此對稱軸不可能在 $y$ 軸上，排除 (1)！", "<b>頂點縱坐標</b>：頂點最小值為 $-1 < 0$，拋物線與 $x$ 軸有兩個交點。"],
                "pitfall": "容易忽略 $a \\ne 0$ 的非零條件而錯選 (1)。"
            },
            "solution": {
        ...
        # 28 -> 23
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第23題",
            "topic": "多項式給定點導數聯立求解", "score": "8分",
            ...
            "knowledge": {
                ...
                "points": ["<b>零點處求導速算訣竅</b>：若 $f(x) = (x-r) g(x)$，則 $f'(r) = g(r)$！", "代入得：$y'(a) = a(a-b) = -1$，即 $a(b-a) = 1$；$y'(b) = b(b-a) = 2$。"],
        ...
        # 29 -> 24
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第24題",
            "topic": "用導數極限定義求導 (一次分式/二次式)", "score": "6分",
            ...
            "knowledge": {
                ...
                "points": ["<b>定義法三步曲</b>：① 求增量 $\\Delta y$；② 算差商 $\\frac{\\Delta y}{\\Delta x}$；③ 取極限 $\\lim_{\\Delta x \\to 0}$。", "規範作答必須寫出 $\\Delta x$ 的極限式，不能直接寫求導公式。"],
        ...
        # 30 -> 25
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第25題",
            "topic": "用導數極限定義求導 (一般二次多項式)", "score": "6分",
            ...
            "knowledge": {
                ...
                "points": ["<b>展開化簡</b>：$3(x+\\Delta x)^2 - 2(x+\\Delta x) = 3x^2 + 6x\\Delta x + 3(\\Delta x)^2 - 2x - 2\\Delta x$。", "<b>提出公因式</b>：$\\Delta y = (6x - 2)\\Delta x + 3(\\Delta x)^2$。"],
        ...
        # 31 -> 26
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第26題",
            "topic": "隱函數對數與三角求導", "score": "8分",
            ...
            "knowledge": {
                ...
                "points": ["<b>乘積複合求導</b>：$\\sin(xy)$ 內部的 $xy$ 是乘積，求導為 $(xy)' = y + xy'$。", "<b>因式提取 $y'$</b>：整理出 $y'$ 的係數並移項。"],
        ...
        # 32 -> 27
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第27題",
            "topic": "含自身導數常數項的方程求解", "score": "8分",
            ...
            "knowledge": {
                ...
                "points": ["<b>$f'(3)$ 是常數</b>：本質是待定常數 $C = f'(3)$，求導時作為係數處理。", "<b>代入自身求值</b>：求出 $f'(x)$ 後令 $x = 3$，建立關於 $f'(3)$ 的一元一次方程求解。"],
        ...
        # 33 -> 28
        {
            "year": "2026", "paper": "專題一", "qNum": "解答題 第28題",
            "topic": "分段函數可導性與點方程", "score": "8分",
            ...
            "knowledge": {
                ...
                "points": ["<b>分段討論</b>：分別在 $a < 0$ 與 $0 < a < 1$ 兩區間內求導並解方程。", "<b>定義域檢驗</b>：解出的解必須落在該分段的區間範圍內！"],
