# -*- coding: utf-8 -*-
"""
scripts/gen_ch19_matrices.py
專題十九：行列式及矩陣 (Book P49-52, PDF P47-50, 6 slides)
"""
...
output_js = f"/* 2026 高三理組數學思維本 — 專題十九 行列式及矩陣 ({len(slides)} 題) */\n(function() {{\n  const DECK = window.DECK = window.DECK || [];\n  DECK.push({json.dumps(deck_obj, ensure_ascii=False, indent=2)});\n}})();\n"

with open("demo/ch-senior-19.js", "w", encoding="utf-8") as f:
    f.write(output_js)

print(f"Generated demo/ch-senior-19.js with {len(slides)} slides.")
