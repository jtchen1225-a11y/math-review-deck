# -*- coding: utf-8 -*-
"""
Ch 02: 專題二 導數的應用 — 切線、極值、單調性與最優化 (23 題)
涵蓋：單選 1~6、切線方程 7~9、極值與拐點作圖 10~13、最優化應用 14~15、垂直切線與傾角 16~17、恆成立 18、切線綜合 19~23
"""
...
def get_ch02_slides():
    slides = [
        # 1
        {
            "year": "2026", "paper": "專題二", "qNum": "單選題 第1題",
            "topic": "拋物線與直線相切的切點與參數確定", "score": "4分",
            "q": "函數 $y = ax^2 + 1$ 的圖像與直線 $y = x$ 相切，則實數 $a = (\\quad)$。",
            "options": ["A. $\\frac{1}{8}$", "B. $\\frac{1}{4}$", "C. $\\frac{1}{2}$", "D. 1"],
            "knowledge": {
                "formulas": [
                    "y' = 2ax",
                    "\\text{切線斜率：} 2ax_0 = 1",
                ...
                "points": ["<b>切線幾何條件</b>：切點處函數值相等且導數等於直線斜率 1。", "<b>判別式法</b>：聯立 $ax^2 - x + 1 = 0$，相切等價於判別式 $\\Delta = 0$。"],
        ...
        # 2
        {
            "year": "2026", "paper": "專題二", "qNum": "單選題 第2題",
            "topic": "曲線切線與垂直直線斜率條件", "score": "4分",
            ...
            "knowledge": {
                ...
                "points": ["<b>切線斜率</b>：在點 $x=3$ 處求導得 $k_1 = y'(3) = -\\frac{2}{(3-1)^2} = -\\frac{1}{2}$。", "<b>直線斜率</b>：直線 $ax + y + 3 = 0 \\implies y = -ax - 3$，斜率 $k_2 = -a$。"],
        ...
        # 3
        {
            "year": "2026", "paper": "專題二", "qNum": "單選題 第3題",
            "topic": "三次多項式極小值點分佈區間", "score": "4分",
            "q": "函數 $f(x) = x^3 - 6b^2 x + 3b$ 在區間 $(0, 1)$ 內有極小值，則實數 $b$ 的取值範圍是 $(\\quad)$。",
            "options": ["A. $b > 0$", "B. $b < \\frac{1}{2}$", "C. $0 < b < \\frac{\\sqrt{2}}{2}$", "D. $b < 1$"],
            "knowledge": {
                "formulas": [
                    "f'(x) = 3x^2 - 6b^2 = 3(x^2 - 2b^2)",
                    "\\text{極值可疑點：} x = \\pm \\sqrt{2}|b|"
                ],
                "points": ["<b>極小值點判定</b>：三次多項式二次項為 0，導函數根為 $-\\sqrt{2}|b|$（極大值點）和 $+\\sqrt{2}|b|$（極小值點）。", "<b>開區間約束</b>：極小值點 $x = \\sqrt{2}|b|$ 必須落在開區間 $(0, 1)$ 內。"],
        ...
        # 4
        {
            "year": "2026", "paper": "專題二", "qNum": "單選題 第4題",
            "topic": "原函數曲線的極值點個數辨析", "score": "4分",
            ...
            "knowledge": {
                ...
                "points": ["<b>原函數極值點特徵</b>：原函數圖像的「波峰」（局部極大值）與「波谷」（局部極小值）。", "<b>圖形逐點觀察</b>：在 $x=a$ 處為波谷（極小值），在 $x=b$ 處為波峰（極大值），在 $x=d$ 處為波谷（極小值），端點 $m, n$ 為開區間不計入。"],
        ...
        # 5
        {
            "year": "2026", "paper": "專題二", "qNum": "單選題 第5題",
            "topic": "導函數符號變化判斷極小值點個數", "score": "4分",
            ...
            "knowledge": {
                ...
                "points": ["<b>看清圖象是導函數 $y = f'(x)$</b>：極小值點對應導函數圖像由 $x$ 軸下方穿到上方（負變正的穿零點）。", "<b>相切零點不變號</b>：在原點處導函數相切於 $x$ 軸未變號，不構成極值點。"],
        ...
        # 6
        {
            "year": "2026", "paper": "專題二", "qNum": "單選題 第6題",
            "topic": "三次多項式全實數單調性與判別式", "score": "4分",
            ...
            "knowledge": {
                ...
                "points": ["<b>全域單調條件</b>：三次項係數為 $-1 < 0$，函數必在全實數上單調遞減，等價於 $f'(x) \\le 0$ 恆成立。", "<b>二次型恆負條件</b>：二次項係數 $-3 < 0$，只需判別式 $\\Delta \\le 0$。"],
        ...
        # 7
        {
            "year": "2026", "paper": "專題二", "qNum": "解答題 第7題",
            "topic": "高次複合多項式切線方程", "score": "6分",
            ...
            "knowledge": {
                ...
                "points": ["<b>檢驗點是否在曲線上</b>：將 $x=0$ 代入得 $f(0) = (1+0)^{10} = 1$，說明 $(0, 1)$ 恰好就是切點！", "<b>點斜式寫方程</b>：直接由切點斜率寫出切線方程。"],
        ...
        # 8
        {
            "year": "2026", "paper": "專題二", "qNum": "解答題 第8題",
            "topic": "三角函數在零點處的切線方程", "score": "6分",
            ...
            "knowledge": {
                ...
                "points": ["<b>切線斜率</b>：$y'\\left(\\frac{\\pi}{3}\\right) = 3\\cos\\left(3 \\cdot \\frac{\\pi}{3}\\right) = 3\\cos\\pi = -3$。", "<b>點斜式方程</b>：$y - 0 = -3\\left(x - \\frac{\\pi}{3}\\right)$。"],
        ...
        # 9
        {
            "year": "2026", "paper": "專題二", "qNum": "解答題 第9題",
            "topic": "隱函數曲線的切線方程", "score": "8分",
            ...
            "knowledge": {
                ...
                "points": ["<b>乘積法則隱函數求導</b>：對 $xy^2$ 與 $x^2 y$ 分別運用乘積求導。", "<b>切點代入求斜率</b>：將 $x = -2, y = 3$ 直接代入導函數方程解出 $y'$。"],
        ...
        # 10
        {
            "year": "2026", "paper": "專題二", "qNum": "解答題 第10題",
            "topic": "常見函數的極值求解 (分式、根式差、三次多項式)", "score": "10分",
            ...
            "knowledge": {
                ...
                "points": ["<b>(1) 定義域 $x \\ne 0$</b>：$f'(x) = 3x^2 - 3/x^2 = 0 \\implies x^4 = 1$。", "<b>(2) 根式定義域</b>：$2x+4 \\ge 0$ 且 $x+3 \\ge 0 \\implies x \\ge -2$。", "<b>(3) 判別式無根</b>：$f'(x) = 3x^2 - 6x + 6 = 3[(x-1)^2 + 1] > 0$ 恆成立，無極值！"],
        ...
        # 11
        {
            "year": "2026", "paper": "專題二", "qNum": "解答題 第11題",
            "topic": "四次多項式的單調區間、極值與拐點", "score": "10分",
            ...
            "knowledge": {
                ...
                "points": ["<b>因式分解一階導</b>：$x^3 - x^2 - x + 1 = x^2(x-1) - (x-1) = (x-1)^2(x+1)$。", "<b>二重根不改變符號</b>：$x = 1$ 是二重根，導函數在 $x=1$ 兩側不變號，故 $x=1$ 不是極值點！", "<b>拐點判定</b>：二階導零點 $x = 1, -1/3$ 處符號均發生改變，皆為拐點。"],
        ...
        # 12
        {
            "year": "2026", "paper": "專題二", "qNum": "解答題 第12題",
            "topic": "閉區間多項式函數的最大值", "score": "6分",
            ...
            "knowledge": {
                ...
                "points": ["<b>駐點落在區間內</b>：區間為 $[-1, 3]$，駐點 $-2$ 不在區間內，只有 $x = 0$ 和 $x = 2$ 在區間內。", "<b>列值表對比</b>：計算 $x = -1, 0, 2, 3$ 四個點的函數值。"],
        ...
        # 13
        {
            "year": "2026", "paper": "專題二", "qNum": "解答題 第13題",
            "topic": "函數圖形描繪 (漸近線、極值點與拐點)", "score": "10分",
            ...
            "knowledge": {
                ...
                "points": ["<b>(1) 奇函數與垂直漸近線</b>：定義域 $x \\ne \\pm 1$，垂直漸近線為 $x = \\pm 1$，水平漸近線為 $y = 0$。導函數恆負，無極值，拐點在原點 $(0, 0)$。", "<b>(2) 三次函數經典形態</b>：極大值點 $(1, -6)$，極小值點 $(3, -10)$，對稱中心（拐點）為 $(2, -8)$。"],
        ...
        # 14
        {
            "year": "2026", "paper": "專題二", "qNum": "解答題 第14題",
            "topic": "拋物線內接矩形面積最優化", "score": "10分",
            ...
            "knowledge": {
                ...
                "points": ["<b>對稱性定底長</b>：由於拋物線關於 $y$ 軸對稱，矩形底長為 $2s$，高為 $t = 12 - s^2$。", "<b>求導求最值</b>：令面積導函數為 0 求出最優尺寸。"],
        ...
        # 15
        {
            "year": "2026", "paper": "專題二", "qNum": "解答題 第15題",
            "topic": "無蓋長方體盒表面積最小化工程最優設計", "score": "10分",
            ...
            "knowledge": {
                ...
                "points": ["<b>開口無蓋</b>：表面積只有 1 個底面加上 4 個側面，即 $S = x^2 + 4xh$。", "<b>材料最少等價於表面積最小</b>：令 $S'(x) = 0$ 求解最優尺寸。"],
        ...
        # 16
        {
            "year": "2026", "paper": "專題二", "qNum": "單選題 第16題",
            "topic": "垂直直線與三次曲線切線方程", "score": "4分",
            ...
            "knowledge": {
                ...
                "points": ["<b>切線斜率確定</b>：垂直直線斜率為 $1/3$ 的負倒數，即 $-3$。", "<b>切點求解</b>：$3x^2 + 6x + 3 = 0 \\implies 3(x+1)^2 = 0 \\implies x = -1$。"],
        ...
        # 17
        {
            "year": "2026", "paper": "專題二", "qNum": "單選題 第17題",
            "topic": "導函數取值範圍與切線傾斜角的最值", "score": "4分",
            "q": "函數 $y = \\frac{x^3}{3} - x^2 + 1$ ($0 < x < 2$) 的圖形上任意點處切線的傾斜角記為 $\\alpha$，則 $\\alpha$ 的最小值是 $(\\quad)$。",
            "options": ["A. $\\frac{\\pi}{4}$", "B. $\\frac{\\pi}{6}$", "C. $\\frac{5\\pi}{6}$", "D. $\\frac{3\\pi}{4}$"],
            "knowledge": {
                "formulas": [
                    "k = \\tan\\alpha = y' = x^2 - 2x = (x-1)^2 - 1",
                    "\\alpha \\in [0, \\pi)"
                ],
                "points": ["<b>斜率取值範圍</b>：當 $x \\in (0, 2)$ 時，$(x-1)^2 \\in [0, 1)$，故 $k = (x-1)^2 - 1 \\in [-1, 0)$。", "<b>正切與傾斜角關係</b>：當斜率 $k < 0$ 時，傾斜角為鈍角 $\\alpha \\in (\\frac{\\pi}{2}, \\pi)$。$\\tan\\alpha$ 越小（負得越多），鈍角 $\\alpha$ 越小！"],
        ...
        # 18
        {
            "year": "2026", "paper": "專題二", "qNum": "填空題 第18題",
            "topic": "不等式恆成立轉化為全域最小值問題", "score": "4分",
            ...
            "knowledge": {
                ...
                "points": ["<b>恆成立轉化最值</b>：只需函數 $g(x) = x^4 - 4x^3$ 的最小值大於等於 $2 - a$。", "<b>二重根符號不變</b>：$g'(x) = 4x^2(x-3)$，在 $x=0$ 兩側導函數均非正，全域最小值唯一在 $x=3$ 處取得。"],
        ...
        # 19
        {
            "year": "2026", "paper": "專題二", "qNum": "填空題 第19題",
            "topic": "切線方程逆讀函數值與導數值", "score": "4分",
            ...
            "knowledge": {
                ...
                "points": ["<b>切點在切線上</b>：切點的縱坐標可直接代入切線方程求出 $f(5) = -5 + 8 = 3$。", "<b>導數即切線斜率</b>：切線方程 $y = -x + 8$ 的斜率為 $-1$，故 $f'(5) = -1$。"],
        ...
        # 20
        {
            "year": "2026", "paper": "專題二", "qNum": "解答題 第20題",
            "topic": "過原點的外點切線方程求解", "score": "8分",
            ...
            "knowledge": {
                ...
                "points": ["<b>外點切線標準解法</b>：設切點為 $(x_0, y_0)$，切線過原點等價於切點到原點的斜率等於切線導數斜率。", "<b>有兩條切線</b>：一元二次方程有兩個不同實根，對應兩條過原點的切線。"],
        ...
        # 21
        {
            "year": "2026", "paper": "專題二", "qNum": "解答題 第21題",
            "topic": "切線方程已知求點函數值與導數值", "score": "6分",
            ...
            "knowledge": {
                ...
                "points": ["<b>切點在切線上</b>：$f(1) = 1/2 + 2 = 5/2$。", "<b>導數為斜率</b>：$f'(1) = 1/2$。"],
        ...
        # 22
        {
            "year": "2026", "paper": "專題二", "qNum": "解答題 第22題",
            "topic": "含參三次多項式極小值待定係數與畫圖", "score": "10分",
            ...
            "knowledge": {
                ...
                "points": ["<b>極值點兩大條件</b>：① 函數值等於極值 $f(1) = -1$；② 駐點導數為零 $f'(1) = 0$。", "<b>二階導驗證極小值</b>：$f''(1) > 0$ 確保是極小值而不是極大值。"],
        ...
        # 23
        {
            "year": "2026", "paper": "專題二", "qNum": "解答題 第23題",
            "topic": "奇函數對稱性與三次函數解析式", "score": "8分",
            ...
            "knowledge": {
                ...
                "points": ["<b>原點對稱（奇函數）</b>：多項式中不含偶次項（即 $x^2$ 係數與常數項均為 0），簡化為 $f(x) = ax^3 + cx$！", "<b>聯立求係數</b>：只需兩個未知數 $a, c$，由極值條件列二元一次方程組。"],
