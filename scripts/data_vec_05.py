...
"""
專題五：集合與數學歸納法 (8 題)
Page 9 底部 1~7 題（含四校聯考、澳門大學UMB、內地聯招、澳門科大真題）
"""
    ...
    "slides": [
        ...
        },
        {
            ...
            "knowledge": {
                ...
                "points": ["注意條件限制 $x \\in \\mathbb{Z}$，求出連續區間後必須列舉出其中的整數解！"]
            },
            "solution": {
        ...
        },
        {
            ...
            "options": ["A. $Q$", "B. $\\emptyset$", "C. $\\{2\\}$", "D. $P$"],
            "knowledge": {
                "formulas": [
        ...
        },
        {
            ...
            "options": ["A. 2 個", "B. 4 個", "C. 5 個", "D. 7 個"],
            "knowledge": {
                "formulas": [
        ...
        },
        {
            ...
            "knowledge": {
                ...
                "points": ["指數增長速度遠超二次函數增長速度，當 $n \\ge 6$ 時恆有 $2^n > (n+1)^2$。"]
            },
            "solution": {
