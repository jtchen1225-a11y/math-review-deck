...
(function() {
  ...
  DECK.push({
    ...
    slides: [
      ...
      "knowledge": {
            "formulas": [
                  "|AC| = \\frac{|AP|}{\\tan(\\pi/6)} = \\sqrt{3}",
                  "|AD| = |AP| = 1 \\implies |CD|^2 = |AC|^2 + |AD|^2",
                  "S = \\frac{1}{2}ab \\sin \\theta"
            ],
            "points": [
                  "<b>直角三角形三角比</b>：在 Rt$\\triangle PAC$ 中直接求出邊長 $|AC| = \\sqrt{3}$。",
                  "<b>勾股定理逆定理</b>：$|AD|^2 + |AC|^2 = 1 + 3 = 4 = |CD|^2 \\implies \\angle DAC = 90^\\circ$。",
                  "<b>等邊三角形邊長</b>：$\\triangle ABC$ 為正三角形，邊長 $|AB| = |AC| = \\sqrt{3}$。"
            ],
      ...
      "knowledge": {
            "formulas": [
                  "h = \\sqrt{1 - x^2}, \\quad V(x) = \\frac{1}{3}\\pi x^2 h = \\frac{\\pi}{3} x^2 \\sqrt{1 - x^2}",
                  "V^2(x) = \\frac{\\pi^2}{9} x^4 (1 - x^2) = \\frac{\\pi^2}{9}(x^4 - x^6)",
                  "\\frac{d(V^2)}{dx} = \\frac{\\pi^2}{9}(4x^3 - 6x^5) = 0 \\implies x^2 = \\frac{2}{3} \\implies x = \\sqrt{\\frac{2}{3}}"
            ],
            "points": [
                  "<b>平方簡化求導法</b>：因為 $V > 0$，$V$ 取得最大值等價於 $V^2$ 取得最大值，從而擺脫根號求導！",
                  "<b>駐點二階導檢驗</b>：二階導數小於 0 確認為極大值點。"
            ],
      ...
      "knowledge": {
            "formulas": [
                  "L: y = k(x - \\sqrt{5}) \\implies x = \\frac{y}{k} + \\sqrt{5}",
                  "4x^2 - y^2 = 4 \\implies (4 - k^2)x^2 - 2\\sqrt{5}k^2 x + (5k^2 - 4) = 0",
                  "\\vec{OA} \\cdot \\vec{OB} = x_1 x_2 + y_1 y_2 = 0"
            ],
            "points": [
                  "<b>漸近線斜率限制</b>：雙曲線漸近線斜率為 $\\pm \\frac{b}{a} = \\pm 2$，$k^2 \\ne 4$。",
                  "<b>以 $y$ 為主元化簡</b>：將直線寫為 $x = \\frac{y}{k} + \\sqrt{5}$ 代入雙曲線求 $y_1+y_2$ 和 $y_1 y_2$ 更為流暢。"
            ],
      ...
      "knowledge": {
            "formulas": [
                  "\\sqrt{3}+i = 2 e^{i\\pi/6}, \\quad 1+i = \\sqrt{2} e^{i\\pi/4} \\implies \\frac{\\sqrt{3}+i}{1+i} = \\sqrt{2} e^{-i\\pi/12}",
                  "(\\cos\\alpha + i\\sin\\alpha)^5 = \\cos 5\\alpha + i\\sin 5\\alpha"
            ],
            "points": [
                  "<b>複數商的極式法則</b>：模長相除 $r = 2/\\sqrt{2} = \\sqrt{2}$，輻角相減 $\\theta = \\pi/6 - \\pi/4 = -\\pi/12$。",
                  "<b>二項式展開取實部</b>：展開 $(\\cos\\alpha + i\\sin\\alpha)^5$ 取實部即得 $\\cos 5\\alpha$。"
            ],
      ...
      "paper": "附加卷",
      "qNum": "第5題",
      "topic": "高等代數 · 三階行列式因式分解與 Vandermonde 應用",
      "score": "20分",
      ...
      "knowledge": {
            "formulas": [
                  "R_2 + R_1 = (a+b+c, a+b+c, a+b+c)",
                  "D = (a+b+c)(b-a)(c-a)(c-b)",
                  "\\text{柯西不等式：}(a^2+b^2+c^2)(1^2+1^2+1^2) \\ge (a+b+c)^2"
            ],
            "points": [
                  "<b>行變換提取公因式</b>：第 2 行加上第 1 行後，整行元素全為 $a+b+c$，直接提出！",
                  "<b>降階化簡范德蒙型行列式</b>：剩下兩行做列差分，迅速因式分解為 $(b-a)(c-a)(c-b)$。",
                  "<b>柯西不等式/均值不等式證明最小值</b>：利用 $(a+b+c)^2 \\le 3(a^2+b^2+c^2)$。"
            ],
